...
|---|---|---|
| **Encoding** | `btoa(\`${identifier}:${password}\`)` — standard HTTP Basic Auth (Base64) | [auth.js:70](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/src/infra/auth.js#L70) |
| **Transport** | `fetch(AUTH_URL, { ... })` over **HTTPS only** (`https://platform.zone01.gr`) | [auth.js:72](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/src/infra/auth.js#L72) |
| **Header** | `Authorization: Basic ${credentials}` | [auth.js:75](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/src/infra/auth.js#L75) |
| **Credentials option** | `credentials: "omit"` — no cookies sent | [auth.js:79](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/src/infra/auth.js#L79) |
...
The CSP meta tag in [index.html:6](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/index.html#L6) enforces:
...
|---|---|---|---|---|
| **Functional** | | | | |
| A1 | Invalid credentials → appropriate error shown? | E2E (Playwright) | [workflow.e2e.mjs:110-128](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L110-L128) | ✅ |
| A2 | Valid login → profile with three sections? | E2E + Unit | [workflow.e2e.mjs:143-147](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L143-L147), [requirements-and-audit.spec.mjs:27-31](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L27-L31) | ✅ |
| A3 | Content accuracy verified via GraphiQL? | E2E | [workflow.e2e.mjs:149-153](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L149-L153) | ✅ |
| A4 | Fourth section for graphical statistics? | E2E + Unit | [workflow.e2e.mjs:156](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L156), [requirements-and-audit.spec.mjs:33-44](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L33-L44) | ✅ |
| A5 | At least two SVG graphs? | E2E + Unit | [workflow.e2e.mjs:159-160](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L159-L160), [requirements-and-audit.spec.mjs:46-54](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L46-L54) | ✅ |
| A6 | Graphs display expected data accurately? | E2E | [workflow.e2e.mjs:163-165](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L163-L165) | ✅ |
| A7 | Profile accessible from host domain? | — | No automated test (deployment-only) | ⚠️ Manual |
| A8 | Logout successful? | E2E | [workflow.e2e.mjs:169-171](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L169-L171), [app.e2e.mjs:324-336](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/runtime/app.e2e.mjs#L324-L336) | ✅ |
| **General** | | | | |
| A9 | Mandatory query types (nested, normal, arguments)? | E2E + Unit | [workflow.e2e.mjs:174-222](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L174-L222), [graphql-query-types.spec.mjs](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/graphql-query-types.spec.mjs) | ✅ |
| **Bonus** | | | | |
| A10 | Additional info beyond three sections? | Unit | [requirements-and-audit.spec.mjs:27-31](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L27-L31) — Skills + Activity sections in HTML | ✅ |
| A11 | Additional graphs beyond two? | Unit | [requirements-and-audit.spec.mjs:36-43](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L36-L43) — 4 graph containers | ✅ |
| A12 | Own GraphiQL created? | — | Not applicable (uses platform GraphiQL) | N/A |
| A13 | UI good practices? | Unit | [login-autofill-theme.spec.mjs](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/login-autofill-theme.spec.mjs) | ✅ |

### 2.2 Requirements Coverage (`docs/requirements.md`)

| # | Requirement | Test Type | Test File(s) | Covered? |
|---|---|---|---|---|
| R1 | Login with username:password | E2E | [workflow.e2e.mjs:139-141](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L139-L141), [app.e2e.mjs:289-299](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/runtime/app.e2e.mjs#L289-L299) | ✅ |
| R2 | Login with email:password | Unit | [requirements-and-audit.spec.mjs:20-25](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L20-L25) (field accepts both) | ✅ |
| R3 | Invalid credentials → error message | E2E + Unit | [workflow.e2e.mjs:110-128](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L110-L128), [api-result-contract.spec.mjs:83-98](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/api-result-contract.spec.mjs#L83-L98) | ✅ |
| R4 | JWT obtained from signin endpoint | Unit | [api-result-contract.spec.mjs:66-81](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/api-result-contract.spec.mjs#L66-L81) | ✅ |
| R5 | Basic Auth with base64 encoding | Static | [security-hardening.spec.mjs](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/security-hardening.spec.mjs) — fetch hardening checks | ✅ |
| R6 | Bearer auth for GraphQL queries | Unit | [api-result-contract.spec.mjs:100-131](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/api-result-contract.spec.mjs#L100-L131) | ✅ |
| R7 | Logout method provided | E2E + Unit | [requirements-and-audit.spec.mjs:61-64](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L61-L64), [app.e2e.mjs:324-336](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/runtime/app.e2e.mjs#L324-L336) | ✅ |
| R8 | Three profile data sections | E2E + Unit | [workflow.e2e.mjs:143-147](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L143-L147), [requirements-and-audit.spec.mjs:27-31](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L27-L31) | ✅ |
| R9 | Statistics section with SVG graphs | E2E + Unit | [workflow.e2e.mjs:156-165](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L156-L165), [requirements-and-audit.spec.mjs:33-54](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/requirements-and-audit.spec.mjs#L33-L54) | ✅ |
| R10 | At least 2 different graph types | E2E + Unit | Same as R9 — 4 containers verified | ✅ |
| R11 | Normal queries | Unit + E2E | [graphql-query-types.spec.mjs:13-19](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/graphql-query-types.spec.mjs#L13-L19), [workflow.e2e.mjs:213](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L213) | ✅ |
| R12 | Nested queries | Unit + E2E | [graphql-query-types.spec.mjs:33-44](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/graphql-query-types.spec.mjs#L33-L44), [workflow.e2e.mjs:216-218](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L216-L218) | ✅ |
| R13 | Queries with arguments | Unit + E2E | [graphql-query-types.spec.mjs:22-31](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/graphql-query-types.spec.mjs#L22-L31), [workflow.e2e.mjs:221](file:///e:/Ertval%20One/_Software/zone-modules/Modules/graphql/tests/audit/workflow.e2e.mjs#L221) | ✅ |
