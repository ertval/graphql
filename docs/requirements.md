...
You'll use the GraphQL endpoint which is provided by the platform (`https://patform.zone01.gr/api/graphql-engine/v1/graphql`). You'll be able to query your own data to populate your profile page.
...
You'll need a [JWT](https://jwt.io/introduction) to access the GraphQL API. A JWT can be obtained from the `signin` endpoint (`https://patform.zone01.gr/api/auth/signin`).
